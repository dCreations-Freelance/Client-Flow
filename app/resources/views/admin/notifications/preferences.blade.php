<x-layouts.admin :title="'Preferencias de notificaciones'">
    <div class="max-w-3xl mx-auto space-y-6">
        ...
        <form method="POST" action="{{ route('admin.notifications.preferences.update') }}" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div class="flex items-center justify-end gap-3">
                <a href="{{ route('admin.dashboard') }}" class="text-sm font-medium text-[#6B7280] hover:text-[#111827]">
                    Cancelar
                </a>
