    ...
    <main class="mx-auto max-w-6xl px-6 py-14 lg:py-24">
        <div class="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
            <section>
                ...
                <p class="mt-6 max-w-2xl text-lg leading-8 text-[#6B7280]">Seguimiento visual, entregables, comentarios, documentos y aprobaciones en un único espacio profesional.</p>
            ...
            <section class="rounded-[28px] border border-[#E7E2D8] bg-white p-6 shadow-[0_10px_30px_rgba(17,24,39,0.05)]">
                <div class="flex items-start justify-between gap-4">
                    <div>
                        ...
                        <h2 class="mt-1 text-xl font-semibold">Web corporativa clínica</h2>
                    </div>
                ...
                <div class="mt-8 rounded-[20px] bg-[#F4F1EA] p-5">
                    <p class="text-sm font-medium">Último avance</p>
                    <p class="mt-2 text-sm leading-6 text-[#6B7280]">Demo del formulario de contacto publicada para revisión del cliente.</p>
                </div>
            </section>
        </div>
    </main>
