<aside class="border-b border-[#E7E2D8] bg-white lg:sticky lg:top-0 lg:h-screen lg:w-[240px] lg:border-b-0 lg:border-r">
    ...
    <nav class="flex gap-2 overflow-x-auto px-4 pb-4 text-sm lg:block lg:space-y-1 lg:overflow-visible">
        @foreach ([
            ['Dashboard', route('portal.dashboard'), request()->routeIs('portal.dashboard')],
            ['Proyectos', route('portal.dashboard'), request()->routeIs('portal.projects.*')],
            ['Diario visual', route('portal.dashboard'), request()->routeIs('portal.projects.visual-entries.*')],
            ['Documentos', '#', false],
            ['Entregables', '#', false],
            ['Comentarios', '#', false],
            ['Perfil', '#', false],
