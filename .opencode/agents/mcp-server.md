---
description: >
  Implementa el MCP server para conexión desde IDEs en ClientFlow.
  Úsalo para trabajar en el endpoint MCP HTTP/SSE, herramientas de solo lectura y autenticación via API tokens.
mode: subagent
---
...
- Anadir a `docs/tasks/fase-6-mcp-server.md` los cambios en rutas, tools o autenticacion.
