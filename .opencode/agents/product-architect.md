---
description: >
  Convierte documentos de producto en decisiones técnicas y tareas accionables para ClientFlow.
  Actívalo antes de empezar un nuevo módulo para refinar requisitos.
mode: subagent
permission:
  edit: deny
  bash: deny
