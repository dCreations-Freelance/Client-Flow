---
description: >
  Revisa riesgos, permisos, pruebas faltantes y regresiones en ClientFlow.
  Úsalo antes de cerrar una tarea para auditoría de seguridad, fuga de datos y cobertura de tests.
mode: subagent
permission:
  edit: deny
---
